...
> ${config.DESCRIPTION}`;
        ...
        await conn.sendMessage(
            from,
            {
                image: { url: `https://i.ibb.co/nswZ9WcB/upload-1770456482848-a76a1a20-jpg.jpg` },
                caption: dec,
                contextInfo: {
        ...
        await conn.sendMessage(from, {
            audio: { url: 'https://github.com/Courtney250/TECHWORD-V1-/raw/refs/heads/main/autovoice/sigma.m4a' },
            mimetype: 'audio/mp4',
            ptt: true
        }, { quoted: mek });
