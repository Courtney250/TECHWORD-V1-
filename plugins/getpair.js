...
async (conn, mek, m, { from, prefix, quoted, q, reply }) => {
    try {
        ...
        // Validate input
        if (!q) {
            return await reply("*Example -* .pair +25476957XXX");
        }

        // Fetch pairing code
        //const fetch = require("node-fetch");
        const response = await fetch(`https://techword-bot-pair-ey42.onrender.com/pair?phone=${q}`);
        ...
        const doneMessage = "> *TECHWORLD PAIR COMPLETED*";
