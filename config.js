...
BOT_NAME: process.env.BOT_NAME || "Techword",
...
OWNER_NAME: process.env.OWNER_NAME || "courtney",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ courtney*",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://i.ibb.co/nswZ9WcB/upload-1770456482848-a76a1a20-jpg.jpg",
